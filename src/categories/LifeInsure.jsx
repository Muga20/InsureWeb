...
import jsonData from '../assets/data/life.json';
    ...
    return (
      ...
      >
        <div class="container py-5">
          <h1 class="display-4 animated slideInDown mb-4" style={{color:'white'}} >Life Insurance </h1>
          {/**
        ...
        <div class="container">
          <div class="text-center mx-auto container-div-style">
            <h1 class="display-6 mb-5">
              We Provide professional  Life Insurance Services
            </h1>
          </div>
