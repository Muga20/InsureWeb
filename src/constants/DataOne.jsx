...
import jsonData from "../assets/data/general.json";
    ...
    <div>
      ...
      >
        <div class="container py-5">
          <h1
            class="display-4 animated text-center  slideInDown mb-4"
            style={{ color: "white" }}
          >
            {data.name} Insurance
          </h1>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-8 blog-content pe-5">
              ...
              <img
                src={`http://localhost:5173/src/assets/img/${data.imageTwo}`}
                className="img-fluid mb-4 w-70 rounded"
                alt=""
              />
              <p>{data.info1}</p>
            ...
            <div class="col-md-4 sidebar">
              ...
              <div class="sidebar-box">
                ...
                <p>
                  <Link
                    className="btn bg-secondary  btn-md text-white"
              ...
              <img
                src={`http://localhost:5173/src/assets/img/${data.imageThree}`}
                className="img-fluid mb-4 w-70 rounded"
                alt=""
              />
            </div>
